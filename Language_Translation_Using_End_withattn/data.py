...
file_path_train = os.path.join('Language_Translation_Using_End_withattn', 'hun_eng_pairs_train.txt')
file_path_val = os.path.join('Language_Translation_Using_End_withattn', 'hun_eng_pairs_val.txt')
